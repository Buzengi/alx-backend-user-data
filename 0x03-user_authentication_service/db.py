...
class DB:
    ...
    def __init__(self) -> None:
        """
        Module Initialize a new DB instance
        """
    ...
    def _session(self) -> Session:
        """
        Module Memoized session object
        """
    ...
    def add_user(self, email: str, hashed_password: str) -> User:
        """
        Module Create a User object and save it to the database
        Args:
    ...
    def update_user(self, user_id: int, **kwargs) -> None:
        """
        Module Update a user's attributes
        Args:
